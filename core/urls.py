...
urlpatterns = [
    ...
    path('modulos/<int:pk>/comentarios/', views.modulo_comentarios, name='modulo-comentarios'),
    path('comentarios/<int:pk>/', views.comentario_detail, name='comentario-detail'),
    path('comentarios/<int:pk>/curtir/', views.curtir_comentario, name='comentario-curtir'),
